...
1. Перейдите на [сайт](https://politcubes.com):
...
3. Нажмите кнопку «*Редактировать*» и переключите тумблер с двухфакторной авторизацией (2FA):
...
5. После сканирования введите в поле код, который есть в приложении:
...
>Несмотря на данный метод защиты, все же рекомендуем устанавливать уникальные пароли.
   
:::note Примечание!
В случае утраты доступа к кодам двухфакторной авторизации, [обратитесь к администрации](https://vk.com/im?sel=-178448347)

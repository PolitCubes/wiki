...
**1.3.** Любой человек (далее — Игрок), прошедший регистрацию, автоматически соглашается с этим сводом правил и обязуется соблюдать их. Незнание правил не освобождает от ответственности.
...
**1.5.** Администрация не имеет своей обязанностью расследование нарушения против вас, особенно если вы этому не способствуете.

**1.6.** В случае, если происходит ситуация, не регулируемая правилами, администрация оставляет за собой право рассмотреть ситуацию и поступить в соответствии с решением нескольких/всех членов администрации.
...
**2.2.1.** В случае невозможности осуществления транзакции через сайт, покупка производится через группу ВК.
...
**3.1.** Администрация не возвращает ресурсы, потерянные в результате взлома. Защищайте свой аккаунт сложным паролем и с помощью системы 2fa, подключить которую можно в личном кабинете на сайте. 
...
**3.5.** Запрещены любые способы обхода наказания.
...
**4.2.** Играйте так, как это подразумевает игра: не используйте читы, баги, скрипты, X-Ray ресурспаки, и прочие хитрости, дающих преимущество в игре. Хранение/распространение приравнивается к использованию и наказывается аналогично. Установка модификаций в лаунчер наказывается аналогично.
...
**5.1.** При выборе названия вашего города и нации: не используйте мат, оскорбительные названия; никнейм-подобные названия (аля ХмеМ, леха_с_завода); лишенные смысла смысла название и т.д.
...
**8.1.** Война будет считаться действительной лишь в том случае, если есть соответствующий пост о войне на стене группы. Если же его нет, то значит, что война не действительна и вы не имеете право начать осаду, в свою очередь, администрация имеет право эту войну отменить.
...
*Пример: Мы претендуем на землю, которая исторически и идеологически принадлежит нам, а поводом для этой войны стала агрессивная политика некогда нейтрального государства.*  
